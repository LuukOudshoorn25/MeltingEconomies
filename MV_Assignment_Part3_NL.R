...
#year <- data$year[178:236]
pre2 <- diff(data$mean_pre[178:236])
rad2 <- diff(data$mean_rad[178:236])
tmp2 <- diff(data$mean_tmp[178:236])
GDP_cap2 <- diff(data$NY.GDP.PCAP.KD[178:236])
cpi2 <- diff(as.numeric(data$AG.PRD.CROP.XD[178:236]))
cpi2[is.na(cpi2)] <- 0
