...
#year <- data$year[60:118]
pre2 <- diff(data$mean_pre[60:118])
rad2 <- diff(data$mean_rad[60:118])
tmp2 <- diff(data$mean_tmp[60:118])
GDP_cap2 <- diff(data$NY.GDP.PCAP.KD[60:118])
cpi2 <- diff(as.numeric(data$AG.PRD.CROP.XD[60:118]))
cpi2[is.na(cpi2)] <- 0
